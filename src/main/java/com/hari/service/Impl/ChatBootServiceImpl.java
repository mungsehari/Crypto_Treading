...
import com.hari.dto.CoinDto;
import com.hari.response.ApiResponse;
import com.hari.response.FunctionResponse;
...
public class ChatBootServiceImpl implements ChatBootService {
    ...
    String GEMINI_API_KEY="AIzaSyCpxNwK1QXkGjetM2UYDbzPGhzM7G_FkeQ";
    ...
    public FunctionResponse getFunctionResponse(String prompt) throws Exception {
        ...
        System.out.println("Current Name: "+currencyName);
